...
std::string kitchen_cabinet::getmat()
{

	return material;
}

int kitchen_cabinet::get_type()
{
	return 1;
}

bool kitchen_cabinet::can_i_stand_here(const kitchen_vector<rectangle*>& plan, int j)
{
...
std::string kitchen_cabinet::get_name_size()
{
	return material;
}
